...
public class AppTest {
	...
	@Test
	public void TestOfType_WithPizza_TypeOfPizza()
	{
        ...
        @Test
	public void TestOfType_WithPrimo_TypeOfPrimo()
	{
	...
	@Test
	public void TestOfName_WithPizza_NameOfPizza()
	{
		MenuItem p1=new MenuItem(MenuItem.itemType.Pizza, "Margherita", 3.0);
        ...
        @Test
	public void TestOfName_WithPrimo_NameOfPrimo()
	{
		MenuItem k1=new MenuItem(MenuItem.itemType.Primo, "Pasta", 5.0);
    ...
    @Test
    public void TestOfValues_WithPizza_TypeOfPizza()
    {
    	MenuItem p1=new MenuItem(MenuItem.itemType.Pizza, "Margherita", 3.0);
    	assertEquals(MenuItem.itemType.valueOf("Pizza"),p1.getType());
    }

    @Test
    public void TestOfValues_WithPrimo_TypeOfPrimo()
    {
    	MenuItem k1=new MenuItem(MenuItem.itemType.Primo, "Pasta", 5.0);
    	assertEquals(MenuItem.itemType.valueOf("Primo"),k1.getType());
    }
        
    @Test
    public void TestOfNPrice_WithPizza_Price0()
    {
        MenuItem p1=new MenuItem(MenuItem.itemType.Pizza, "Margherita", -3.0);
        assertEquals(0.0,p1.getPrice(),0.0001);
    }

    @Test
    public void TestOfNPrice_WithPrimo_Price0()
    {
        MenuItem k1=new MenuItem(MenuItem.itemType.Primo, "Pasta", -5.0);
        assertEquals(0.0,k1.getPrice(),0.0001);
    }
    ...
    public void SumOfPrice_MoreThan20Elements_RestaurantBillExceptionThrown()
    {
    	try{
    		...
    		System.out.println("Situazione di Errore non raggiunta");
    	}catch(RestaurantBillException e) {
    ...
    public void SumOfPrice_LessThan20AndMoreThan10PizzeTotalPriceMoreThan100Euro_BillDiscountedOf5PercentAndLeastExpensivePizzaGratis()
    {
    	try{
    		...
    		double result=testApp.getOrderPrice(list);
    		assertEquals(97.85, result,0.0001);
    	}catch(RestaurantBillException e) {
    		System.out.println(e.getMessage());
    	}
    }
    ...
    public void SumOfPrice_LessThan10PizzeTotalPriceMoreThan100Euro_BillDiscountedOf5Percent()
    {
    	try{
    		...
    		double result=testApp.getOrderPrice(list);
    		assertEquals(104.025, result,0.0001);
    	}catch(RestaurantBillException e) {
    		System.out.println(e.getMessage());
    	}
    }
    ...
    @Test
    public void SumOfPrice_LessThan20ElementsAnd10OrLessPizzeTotalPriceLessThan100Euro_BillCalculated()
    {
    	try{
    		ArrayList<MenuItem> list = new ArrayList<MenuItem>();
    		MenuItem p1=new MenuItem(MenuItem.itemType.Pizza, "Margherita", 5.0);
    		...
    		double result=testApp.getOrderPrice(list);
    		assertEquals(69.0, result,0.0001);
    	}catch(RestaurantBillException e) {
    		System.out.println(e.getMessage());
    	}
    }
    ...
    @Test
    public void SumOfPrice_LessThan20ElementsAndMoreThan10PizzeTotalPriceLessThan100Euro_BillCalculatedAndLeastExpensivePizzaGratis()
    {
    	try{
    		ArrayList<MenuItem> list = new ArrayList<MenuItem>();
    		for(int i=0;i<3;i++) {
			...
			list.add(k1); list.add(k2); list.add(k3);
			double result=testApp.getOrderPrice(list);
    		assertEquals(66.5, result,0.0001);
    	}catch(RestaurantBillException e) {
    		System.out.println(e.getMessage());
    	}
    }
    ...
    public void SumOfPrice_LessThan20ElementsAndMoreThan10PizzeTotalPriceMoreThan100Euro_BillDiscountedOf5PercentAndLeastExpensivePizzaGratis()
    {
    	try{
			...
			double result=testApp.getOrderPrice(list);
    		assertEquals(106.875, result,0.0001);
    	}catch(RestaurantBillException e) {
    		System.out.println(e.getMessage());
    	}
    }
    ...
    public void SumOfPrice_LessThan20PrimiTotalPriceMoreThan100Euro_BillDiscountedOf5Percent()
    {
    	try{
			...
			double result=testApp.getOrderPrice(list);
    		assertEquals(179.55, result,0.0001);
    	}catch(RestaurantBillException e) {
    		System.out.println(e.getMessage());
    	}
    }
    ...
    @Test
    public void SumOfPrice_LessThan20PrimiTotalPriceLessThan100Euro_BillDiscountedOf5Percent()
    {
    	try{
    		ArrayList<MenuItem> list = new ArrayList<MenuItem>();
    		MenuItem k1=new MenuItem(MenuItem.itemType.Primo, "Pasta", 15.0);
